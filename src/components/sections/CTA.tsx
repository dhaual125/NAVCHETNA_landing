        ...
        <ScrollReveal>
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <h2
                className="mb-5 text-balance text-black"
                style={{
              ...
              >
                Ready to elevate{" "}
                <span style={{ fontFamily: "'Instrument Serif', serif", fontStyle: "italic", color: "#000" }}>your operations?</span>
              </h2>
              <p
                className="mb-8 text-black/50"
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 text-black/50 hover:text-black transition-colors"
