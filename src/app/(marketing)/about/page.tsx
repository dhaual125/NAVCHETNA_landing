  ...
  return (
    <div className="bg-[var(--page-bg)]">
      ...
      {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
          ...
          ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
      <section className="relative flex items-center justify-center overflow-hidden" style={{ paddingTop: "160px", paddingBottom: "100px" }}>
        {/* ── Premium symmetric 5-point gradient system ── */}
        {/* Top-left: lavender/violet */}
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 75% 65% at -8% -5%, rgba(185, 165, 230, 0.60) 0%, transparent 62%)" }} />
        {/* Bottom-left: warm peach/amber */}
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 65% 60% at -5% 108%, rgba(245, 190, 145, 0.55) 0%, transparent 58%)" }} />
        {/* Top-right: soft lilac */}
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 65% 55% at 108% -5%, rgba(210, 185, 245, 0.45) 0%, transparent 60%)" }} />
        {/* Bottom-right: rose blush */}
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 60% 55% at 108% 108%, rgba(245, 185, 200, 0.40) 0%, transparent 58%)" }} />
        {/* Bottom-center: peach warmth to carry stats area */}
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 80% 40% at 50% 110%, rgba(240, 195, 165, 0.30) 0%, transparent 60%)" }} />
        {/* Center white fade — keeps text area clean */}
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 55% 65% at 50% 38%, rgba(255,255,255,0.88) 0%, transparent 72%)" }} />
        {/* Subtle grid on top */}
        <div className="absolute inset-0 pointer-events-none opacity-[0.016]" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,1) 1px, transparent 1px), linear-gradient(90deg, rgba(0,0,0,1) 1px, transparent 1px)`, backgroundSize: "64px 64px" }} />
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Link
                  href="/contact"
                  className="group inline-flex items-center justify-center gap-2 transition-all duration-200 hover:gap-3"
                  style={{
                    background: "#000",
                    color: "#fff",
                    padding: "10px 20px",
                ...
                >
                  Contact
                  <ArrowRight className="size-3.5 text-white/60 transition-transform group-hover:translate-x-0.5" />
                </Link>

                <button
                  onClick={() => { document.getElementById("journey")?.scrollIntoView({ behavior: "smooth" }); }}
                  className="inline-flex items-center gap-2 cursor-pointer transition-all duration-200 hover:bg-black/5"
                  style={{
                    background: "transparent",
                    color: "#000",
                    padding: "10px 20px",
                ...
                >
                  Our Journey
                  <ArrowDown className="size-3.5 text-black/40" />
                </button>
              </div>
              {/* Compact stats row — inside hero so gradient covers it */}
      ...
      >
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <ScrollReveal delay={200}>
            <div
              className="mt-6 rounded-3xl bg-white p-12 md:p-16 flex flex-col items-center text-center"
              style={{
                border: "1px solid rgba(0,0,0,0.07)",
                boxShadow: "0 1px 3px rgba(0,0,0,0.04), 0 4px 16px rgba(0,0,0,0.03)",
              }}
            >
              ...
              <p
                className="text-black/40 max-w-lg mx-auto mb-10 text-pretty"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  fontSize: "15.5px",
                  lineHeight: "1.7",
        ...
        <div className="mx-auto max-w-7xl">
          <ScrollReveal>
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0 z-30 rounded-3xl ring-[0.5px] ring-inset ring-white/[0.08]" />
              ...
              <div className="relative z-10 px-8 sm:px-16 max-w-2xl mx-auto">
                <span
                  className="inline-flex items-center gap-1.5 mb-7 text-white/40"
                  style={{
                    fontFamily: "'Inter', sans-serif",
                    fontSize: "10.5px",
                    fontWeight: 700,
                ...
                <p
                  className="text-white/45 text-pretty mb-12 mx-auto"
                  style={{
                    fontFamily: "'Inter', sans-serif",
                    fontSize: "16px",
                    lineHeight: "1.7",
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                  <Link
                    href="/contact"
                    className="group inline-flex items-center justify-center gap-2 rounded-full bg-white text-black font-medium transition-all hover:bg-white/90 hover:gap-3"
                    style={{
                      padding: "13px 26px",
                      fontFamily: "'Inter', sans-serif",
                      fontSize: "15px",
                  ...
                  >
                    ...
                    <ArrowRight className="size-4 text-black/50 transition-transform group-hover:translate-x-0.5" />
                  </Link>
                  <Link
                    href="/services"
                    className="inline-flex items-center justify-center gap-2 rounded-full text-white font-medium transition-all hover:bg-white/15"
                    style={{
                      padding: "13px 26px",
                      fontFamily: "'Inter', sans-serif",
                      fontSize: "15px",
